...
#include "spack/MapObj/StarNumCheck.h"
#include "spack/MapObj/SMAGSoundLibrary.h"
...
namespace SPack {
    ...
    CREATE_EXT_ACTOR(StarNumCheck, pName);

    CREATE_EXT_ACTOR(SMAGSoundLibrary, pName);
    ...
    */
    ...
    const CreateActorEntry cNewCreateNameObjTable[NUM_ACTORS] = {
        ...
        { "StarNumCheck", createExtActor<StarNumCheck>},
        { "SMAGSoundLibrary", createExtActor<SMAGSoundLibrary>},
        // Ride
